...
const FAQAccordion = () => {
  ...
  return (
    <div className="md:max-w-[720px]  mx-auto px-5 md:px-0 py-16 flex flex-col items-center">
      ...
      <div className="space-y-4 md:space-y-12 my-9">
        {faqs.map((faq, index) => (
          <div
            key={index}
          ...
          >
            ...
            {openIndex === index && (
              <motion.div
                ...
                className="text-[#31312F] text-sm md:text-[18px] mt-2 border rounded-lg border-[#EFE5EB] bg-[#FBF9FA] px-6 py-8 leading-normal"
              >
                {faq.answer}
              </motion.div>
            )}
